...
**App:** 
sudo pacman -S rofi swaync nwg-look pavucontrol blueman zed
...
**Others:**
sudo pacman -S adw-gtk-theme ffmpeg 7zip jq poppler fd ripgrep fzf zoxide resvg imagemagick breeze breeze-icons qt6ct qt5ct kvantum kvantum-qt5 gnome-keyring
...
yay -S nerd-fonts-jetbrains-mono nerd-fonts-fira-code nerd-fonts-hack wlogout ttf-jetbrains-mono-nerd
