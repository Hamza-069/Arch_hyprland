...
> **Note:** Shortcuts may change as the configuration evolves. Check the Hyprland configuration files in [`Config/hypr`](https://github.com/Hamza-069/Arch_hyprland/tree/main/Config/hypr) for the latest keybindings.
